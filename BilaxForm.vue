    ...
    >
      <template slot="items" :class="props.item.class" slot-scope="props">
        ...
        <td v-for="v in props.item.values" :class="props.item.class" :key="v.anno" >
          <v-text-field v-model.number="v.value" reverse placeholder="0" type="number" @change="master(v.anno, props.item.cod)"></v-text-field>
        </td>
...
this.startE(anno);
    ...
    calculatePPB(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPB].values[index_anno].value=this.row[this.PPB1].values[index_anno].value+this.row[this.PPB2].values[index_anno].value+this.row[this.PPB3].values[index_anno].value+this.row[this.PPB4].values[index_anno].value;
      this.startPPB(anno);
    },
    calculatePPD(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD].values[index_anno].value=this.row[this.PPD1].values[index_anno].value+this.row[this.PPD2].values[index_anno].value+this.row[this.PPDF].values[index_anno].value+this.row[this.PPD3].values[index_anno].value+this.row[this.PPD4].values[index_anno].value+this.row[this.PPD5].values[index_anno].value+this.row[this.PPD6].values[index_anno].value+this.row[this.PPD7].values[index_anno].value+this.row[this.PPD8].values[index_anno].value+this.row[this.PPD9].values[index_anno].value+this.row[this.PPDA].values[index_anno].value+this.row[this.PPDB].values[index_anno].value+this.row[this.PPDC].values[index_anno].value+this.row[this.PPDD].values[index_anno].value;
      this.startPPD(anno);
    },
    calculatePPD1(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD1].values[index_anno].value=this.row[this.PPD1A].values[index_anno].value+this.row[this.PPD1B].values[index_anno].value;
      this.startPPD1(anno);
    },
    calculatePPD2(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD2].values[index_anno].value=this.row[this.PPD2A].values[index_anno].value+this.row[this.PPD2B].values[index_anno].value;
      this.startPPD2(anno);
    },
    calculatePPDF(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPDF].values[index_anno].value=this.row[this.PPDFA].values[index_anno].value+this.row[this.PPDFB].values[index_anno].value;
      this.startPPDF(anno);
    },
    calculatePPD3(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD3].values[index_anno].value=this.row[this.PPD3A].values[index_anno].value+this.row[this.PPD3B].values[index_anno].value;
      this.startPPD3(anno);
    },
    calculatePPD4(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD4].values[index_anno].value=this.row[this.PPD4A].values[index_anno].value+this.row[this.PPD4B].values[index_anno].value;
      this.startPPD4(anno);
    },
    calculatePPD5(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD5].values[index_anno].value=this.row[this.PPD5A].values[index_anno].value+this.row[this.PPD5B].values[index_anno].value;
      this.startPPD5(anno);
    },
    calculatePPD6(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD6].values[index_anno].value=this.row[this.PPD6A].values[index_anno].value+this.row[this.PPD6B].values[index_anno].value;
      this.startPPD6(anno);
    },
    calculatePPD7(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD7].values[index_anno].value=this.row[this.PPD7A].values[index_anno].value+this.row[this.PPD7B].values[index_anno].value;
      this.startPPD7(anno);
    },
    calculatePPD8(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD8].values[index_anno].value=this.row[this.PPD8A].values[index_anno].value+this.row[this.PPD8B].values[index_anno].value;
      this.startPPD8(anno);
    },
    calculatePPD9(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPD9].values[index_anno].value=this.row[this.PPD9A].values[index_anno].value+this.row[this.PPD9B].values[index_anno].value;
      this.startPPD9(anno);
    },
    calculatePPDA(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPDA].values[index_anno].value=this.row[this.PPDAA].values[index_anno].value+this.row[this.PPDAB].values[index_anno].value;
      this.startPPDA(anno);
    },
    calculatePPDB(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPDB].values[index_anno].value=this.row[this.PPDBA].values[index_anno].value+this.row[this.PPDBB].values[index_anno].value;
      this.startPPDB(anno);
    },
    calculatePPDC(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPDC].values[index_anno].value=this.row[this.PPDCA].values[index_anno].value+this.row[this.PPDCB].values[index_anno].value;
      this.startPPDC(anno);
    },
    calculatePPDD(anno){
      let index_anno=2019-parseInt(anno);
      this.row[this.PPDD].values[index_anno].value=this.row[this.PPDDA].values[index_anno].value+this.row[this.PPDDB].values[index_anno].value;
      this.startPPDD(anno);
    },
    calculateE(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.E].values[index_anno].value = ;
    },
    calculateEA(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EA].values[index_anno].value = this.row[this.EA1].values[index_anno].value + this.row[this.EA2].values[index_anno].value + this.row[this.EA3].values[index_anno].value + this.row[this.EA4].values[index_anno].value + this.row[this.EA5].values[index_anno].value;
      this.startEA(anno);
    },
    calculateEA5(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EA5].values[index_anno].value = this.row[this.EA51].values[index_anno].value + this.row[this.EA52].values[index_anno].value;
      this.startEA5(anno);
    },
    calculateEB(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EB].values[index_anno].value = this.row[this.EB1].values[index_anno].value + this.row[this.EB2].values[index_anno].value + this.row[this.EB3].values[index_anno].value + this.row[this.EB4].values[index_anno].value + this.row[this.EB5].values[index_anno].value + this.row[this.EB6].values[index_anno].value + this.row[this.EB7].values[index_anno].value + this.row[this.EB8].values[index_anno].value + this.row[this.EB9].values[index_anno].value;
      this.startEB(anno);
    },
    calculateML(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.ML].values[index_anno].value = this.row[this.EA].values[index_anno].value - this.row[this.EB1].values[index_anno].value;
      this.startML(anno);
    },
    calculateEB4(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EB4].values[index_anno].value = this.row[this.EB41].values[index_anno].value + this.row[this.EB42].values[index_anno].value + this.row[this.EB43].values[index_anno].value + this.row[this.EB44].values[index_anno].value + this.row[this.EB45].values[index_anno].value;
      this.startEB4(anno);
    },
    calculateEBITDA(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EBITDA].values[index_anno].value = this.row[this.ML].values[index_anno].value - this.row[this.EB2].values[index_anno].value - this.row[this.EB3].values[index_anno].value - this.row[this.EB4].values[index_anno].value;
      this.startEBITDA(anno);
    },
    calculateEB5(anno) {
      let index_anno = 2019 - parseInt(anno);
      this.row[this.EB5].values[index_anno].value = this.row[this.EB51].values[index_anno].value + this.row[this.EB52].values[index_anno].value + this.row[this.EB53].values[index_anno].value + this.row[this.EB54].values[index_anno].value;
      this.startEB5(anno);
    },
    calculateExB(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.ExB].values[index_anno].value = this.row[this.EA].values[index_anno].value-this.row[this.EB].values[index_anno].value;
},
calculateEC(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC].values[index_anno].value = this.row[this.EC1].values[index_anno].value+this.row[this.EC2].values[index_anno].value-this.row[this.EC3].values[index_anno].value-this.row[this.EC4].values[index_anno].value;
},
calculateEC1(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC1].values[index_anno].value = this.row[this.EC11].values[index_anno].value+this.row[this.EC12].values[index_anno].value+this.row[this.EC13].values[index_anno].value;
},
calculateEC2(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC2].values[index_anno].value = this.row[this.EC21].values[index_anno].value+this.row[this.EC22].values[index_anno].value+this.row[this.EC23].values[index_anno].value+this.row[this.EC24].values[index_anno].value;
},
calculateEC21(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC21].values[index_anno].value = this.row[this.EC211].values[index_anno].value+this.row[this.EC212].values[index_anno].value+this.row[this.EC213].values[index_anno].value+this.row[this.EC215].values[index_anno].value;
},
/*CAMBIARE LA SOMMA DI EC21 (TOGLIERE EC214)*/calculateEC24(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC24].values[index_anno].value = this.row[this.EC241].values[index_anno].value+this.row[this.EC242].values[index_anno].value+this.row[this.EC244].values[index_anno].value+this.row[this.EC245].values[index_anno].value;
},
calculateEC3(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EC3].values[index_anno].value = this.row[this.EC31].values[index_anno].value+this.row[this.EC32].values[index_anno].value+this.row[this.EC33].values[index_anno].value+this.row[this.EC35].values[index_anno].value;
},

calculateED(anno){
  let index_anno=2019-parseInt(anno);
  this.row[this.ED].values[index_anno].value=this.row[this.ED1].values[index_anno].value+this.row[this.ED2].values[index_anno].value;
  startED(anno);
},

calculateED1(anno){
  let index_anno=2019-parseInt(anno);
  this.row[this.ED1].values[index_anno].value=this.row[this.ED11].values[index_anno].value+this.row[this.ED12].values[index_anno].value+this.row[this.ED13].values[index_anno].value;
  startED1(anno);
},

calculateED11(anno){
  let index_anno=2019-parseInt(anno);
  this.row[this.ED11].values[index_anno].value=this.row[this.ED111].values[index_anno].value+this.row[this.ED112].values[index_anno].value;
},

calculateEE(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EE].values[index_anno].value = this.row[this.EE1].values[index_anno].value-this.row[this.EE2].values[index_anno].value;
},
calculateEE1(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EE1].values[index_anno].value = this.row[this.EE11].values[index_anno].value+this.row[this.EE12].values[index_anno].value;
},
calculateEE12(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EE12].values[index_anno].value = this.row[this.EE121].values[index_anno].value+this.row[this.EE122].values[index_anno].value;
},
calculateEE2(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EE2].values[index_anno].value = this.row[this.EE21].values[index_anno].value+this.row[this.EE22].values[index_anno].value+this.row[this.EE23].values[index_anno].value;
},
//E=B è DA CAMBIARE
calculateEF(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EF].values[index_anno].value = this.row[this.E=B].values[index_anno].value+this.row[this.EC].values[index_anno].value+this.row[this.ED].values[index_anno].value+this.row[this.EE].values[index_anno].value;
},
calculateEF1(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EF1].values[index_anno].value = (this.row[this.EF].values[index_anno].value*28)/100;
},
calculateEF2(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EF2].values[index_anno].value = this.row[this.EF].values[index_anno].value-this.row[this.EF1].values[index_anno].value;
},
calculateEH(anno){
let index_anno = 2019 - parseInt(anno);
this.row[this.EH].values[index_anno].value = this.row[this.EF2].values[index_anno].value-this.row[this.EG].values[index_anno].value;
},
  }
}
</script>
